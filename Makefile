...
ft_strmapi.o ft_strequ.o ft_strsub.o ft_strjoin.o ft_strtrim.o ft_strsplit.o\
ft_strnequ.o ft_itoa.o ft_putchar.o ft_putstr.o ft_putendl.o ft_putnbr.o\
ft_putchar_fd.o ft_putstr_fd.o ft_putendl_fd.o ft_putnbr_fd.o ft_lstnew.o\
ft_lstdelone.o ft_lstdel.o ft_lstadd.o ft_lstiter.o ft_lstmap.o ft_nbrlen.o\
ft_strtolower.o ft_strtoupper.o ft_lstlen.o
